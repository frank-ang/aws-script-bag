...
# For Amazon Coretto JVM, run with JavaFX

JAVA_FX_PATH=/Users/frankang/lib/javafx-sdk-11.0.2/lib
java --module-path $JAVA_FX_PATH --add-modules=javafx.controls -jar target/aws-transcribe-sample-application-1.0-SNAPSHOT-jar-with-dependencies.jar
